...
class SeMethodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create se_method" do
    assert_difference('SeMethod.count') do
      post se_methods_url, params: { se_method: { method_id: @se_method.method_id, method_name: @se_method.method_name } }
    end
  ...
  test "should update se_method" do
    patch se_method_url(@se_method), params: { se_method: { method_id: @se_method.method_id, method_name: @se_method.method_name } }
