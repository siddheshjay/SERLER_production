...
class ParticipantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participant" do
    assert_difference('Participant.count') do
      post participants_url, params: { participant: { participate_id: @participant.participate_id, participate_name: @participant.participate_name } }
    end
  ...
  test "should update participant" do
    patch participant_url(@participant), params: { participant: { participate_id: @participant.participate_id, participate_name: @participant.participate_name } }
