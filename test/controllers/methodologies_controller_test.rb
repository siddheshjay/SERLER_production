...
class MethodologiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create methodology" do
    assert_difference('Methodology.count') do
      post methodologies_url, params: { methodology: { description: @methodology.description, methodology_id: @methodology.methodology_id, methodology_name: @methodology.methodology_name } }
    end
  ...
  test "should update methodology" do
    patch methodology_url(@methodology), params: { methodology: { description: @methodology.description, methodology_id: @methodology.methodology_id, methodology_name: @methodology.methodology_name } }
